package VWB::REST::Postgresql::DBUtil;
...
sub getInstance {
    ...
    if (!defined($instance)){
        ...
        $instance = new VWB::REST::Postgresql::DBUtil(@_);

        if (!defined($instance)){

            confess "Could not instantiate VWB::REST::Postgresql::DBUtil";
        }
    }
    return $instance;
}
