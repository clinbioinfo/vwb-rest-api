...
B<Description:> Instantiate VWB::REST::Logger object

B<Parameters:> 

 %args

B<Returns:> Returns a reference to VWB::REST::Logger
...
sub _initConfiguration {
    ...
    my $conf = q(
    log4perl.logger                    = sub {return VWB::REST::Logger::_getLogLevel();}

    log4perl.appender.Logfile          = Log::Log4perl::Appender::File
    log4perl.appender.Logfile.filename = sub { return VWB::REST::Logger::_getLogfile(); }
...
sub getInstance {
    ...
    if (!defined($instance)){
        ...
        $instance = new VWB::REST::Logger(@_);
...
B<Description:> VWB::REST::Logger class destructor
...
=head1 SYNOPSIS
 ...
 use VWB::REST::Logger;
 my $obj = VWB::REST::Logger::getInstance();
